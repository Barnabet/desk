// Bundles deskd into dist/deskd.mjs with its migrations, Desk's built-in skills and the better-sqlite3 prebuilds
...
// Desk's built-in skills, verified against builtins.json at start (no caches or Finder files, which would break the digests).
